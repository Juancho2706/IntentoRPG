...
- **Mundo abierto**: zona abierta de la Cripta (120×120, terreno orgánico) conectada al pueblo por puertas que se cruzan caminando; entradas a mazmorras instanciadas (contenido difícil), **respawn gradual**, **jefe de mundo** periódico con gran botín, y **obeliscos de evento** que desatan oleadas; tap en el minimapa abre el **mapa descubierto** (niebla de guerra)
